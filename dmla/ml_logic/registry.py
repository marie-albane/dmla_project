...
def save_model(model: keras.Model = None) -> None:
    ...
    print("✅ Modèle sauvegardé localement sous le nom {model_path}")
...
def load_model() -> keras.Model:
    ...
    if not local_model_paths:
        print(f"\n❌ Aucun modèle à charger depuis {DATA_PATH}")
        return None
    ...
    print(f"✅ Chargement en local du dernier modèle, le n° {model_number} au niveau du chemin: {DATA_PATH}")
